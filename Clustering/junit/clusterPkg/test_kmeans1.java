...
public class test_kmeans1 extends TestCase 
{
	//@Test
	//public void test() 
	//{
	...
	//}
	public void testkmeans1constructor() throws Exception
	{
		int k = 2;
		...
		dataarr[3] = p4;
		int acceptableSize = 10;
		kmeans1 Obj = new kmeans1(k, dataarr, acceptableSize);
	}
	
	public void testimplementkmean1Algo() throws Exception
	{
		int dim = 2;
